  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>PTSP MIN 2 SURABAYA</strong>
        </div>
      </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="nomor-antrian" class="btn btn-success rounded-pill px-5 py-2">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="panggilan-antrian" class="btn btn-success rounded-pill px-5 py-2">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <h3>Cek Antrian</h3>
              <p class="mb-4">Halaman Nomor Antrian digunakan pengunjung untuk melihat sisa antrian.</p>
              <a href="/pemohon/antri/panggilan-antrian/tampilan.php" class="btn btn-success rounded-pill px-5 py-2">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy;<script>document.write(new Date().getFullYear())</script> | PTSP MIN 2 Surabaya</a>
      </div>
    </div>
  </footer>
