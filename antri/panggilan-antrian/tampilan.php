    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2">PTSP MIN 2 KOTA SURABAYA</h1>
        </div>
        <!-- breadcrumbs -->
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="/pemohon/antri"><i class="bi-house-fill text-success"></i></a></li>
            ...
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  ...
                  <p class="mb-0">No Antrian Sekarang</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  ...
                  <p class="mb-0">No Antrian Selanjutnya</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body p-4">
              <div class="d-flex justify-content-start">
                ...
                <div>
                  ...
                  <p class="mb-0">Sisa No Antrian</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, loket, layanan", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
