...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index">MIN 2 KOTA SURABAYA</a>
            ...
            <ul class="navbar-nav navbar-sidenav sidebar-menu" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Version">
                    <a class="nav-link" href="#VersionModal" data-toggle="modal" data-target="#VersionModal">
                        ...
                        <span class="nav-link-text">SH</span>
                    </a>
                </li>
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-table"></i> Tiket Masuk
                </div>
                <div class="card-body">
...
?>
            ...
            <div class="modal-dialog modal-lg " role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        <h5 class="modal-title text-center">Detail Tiket</h5>
                    </div>
        ...
        <div class="modal fade" id="ModalBalas<?php echo $key['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">TL Tiket</h5>
                    </div>
                    <div class="modal-body">
                        <form  method="post">
                            ...
                            <div class="form-group">
                                <p><b>Tanggapan :</b></p>
                                <textarea class="form-control" name="isi_tanggapan" placeholder="Isikan SELESAI jika selesai melayani tamu PTSP" required></textarea>
                            </div>
                            <div class="modal-footer">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $key['id']; ?>" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-sm " role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        <h5 class="modal-title text-center">Hapus Tiket</h5>
                    </div>
                    <div class="modal-body">
                        <p class="text-center">Hapus Tiket</p>
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>Copyright © MIN 2 KOTA SURABAYA 2022</small>
                </div>
            </div>
        </footer>
        ...
        <div class="modal fade" id="VersionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h5 style="text-align : center;">SH</h5>
                        <p style="text-align : center;">Copyright © MIN 2 KOTA SURABAYA 2022</p>
                    </div>
                    <div class="modal-footer">
