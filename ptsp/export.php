            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        ...
                        .css( 'font-size', '10pt' )
                        .prepend(
                            '<img src="min2.png" style="opacity: 0.5; display:block;margin-left: auto; margin-top: auto; margin-right: auto; width: 100px;" />'
                        );
                    }
                },
                {
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-table"></i> Cetak Tiket Masuk
                </div>
                <div class="card-body">
