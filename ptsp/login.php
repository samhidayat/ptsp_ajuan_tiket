...
<head>
    ...
    <link rel="shortcut icon" href="https://min2surabaya.web.id/login/upload/logooke%20(FILEminimizer).png"> 
...
<body id="gradient">
    <div class="container">
        <div class="card container card-login mx-auto mt-5">
            <h5 class="text-center" style="padding-top:8px; font-family: monospace;"><center><a href="../"><strong>PTSP MIN 2 KOTA SURABAYA</strong></a></center><br>Login Petugas</h5>
            <hr class="custom">
            <div class="card-body">
                <form method="post">
